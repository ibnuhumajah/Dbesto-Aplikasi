...
public class Pemesanan2 extends AppCompatActivity implements PembayaranLoadListener, CartLoadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("Daftar Pesanan Meja 2");
                        ...
                        if (snapshot.exists()) {
                            for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                                ...
                                FirebaseDatabase.getInstance(stringaddress.firebaseDbesto)
                                        .getReference("pembayaran").child("2").child(pembayaranModel.getKey())
                                        .removeValue();

                                FirebaseDatabase.getInstance(stringaddress.firebaseDbesto)
                                        .getReference("cart").child("2").child(pembayaranModel.getKey())
                                        .removeValue();
                                    ...
                                    public void onDataChange(@NotNull DataSnapshot snapshot) {
                                        {
                                            ...
                                            Intent proses = new Intent(Pemesanan2.this, PelayananMain.class);
