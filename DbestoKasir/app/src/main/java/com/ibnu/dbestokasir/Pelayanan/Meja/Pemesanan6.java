...
public class Pemesanan6 extends AppCompatActivity implements PembayaranLoadListener, CartLoadListener {
...
//        empty = (LinearLayout)findViewById(R.id.datakosong);
        ...
        textView.setText("Daftar Pesanan Meja 6");
                        ...
                        if (snapshot.exists()) {
                            for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                                ...
                                FirebaseDatabase.getInstance(stringaddress.firebaseDbesto)
                                        .getReference("pembayaran").child("6").child(pembayaranModel.getKey())
                                        .removeValue();

                                FirebaseDatabase.getInstance(stringaddress.firebaseDbesto)
                                        .getReference("cart").child("6").child(pembayaranModel.getKey())
                                        .removeValue();
                                    ...
                                    public void onDataChange(@NotNull DataSnapshot snapshot) {
                                        {
                                            ...
                                            Intent proses = new Intent(Pemesanan6.this, PelayananMain.class);
